...
CREATE TABLE `furn` (
  ...
  `company` varchar(63) NOT NULL DEFAULT '',
  `price` decimal(10,2) NOT NULL DEFAULT '0.00',
  `sales` int NOT NULL DEFAULT '0',
  `stock` int NOT NULL DEFAULT '0',
  `img_path` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE KEY `furn_pk_2` (`name`)
...
INSERT INTO `furn` (`id`, `name`, `company`, `price`, `sales`, `stock`, `img_path`) VALUES (1,'可达鸭','com',321.00,0,123,'test'),(10,'123','321',3.00,0,2,'successfully');
...
-- Dump completed on 2024-08-06 17:10:06
